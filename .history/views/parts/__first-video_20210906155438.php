        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="social-box text-center">
                    <a href="#subscribe" class="btn btn-outline-info">NHẬN THÔNG BÁO</a>
                    <ul class="social">
            ...
            <div class="col-lg-4 d-none d-sm-block">
                <small style="text-align: justify;">
                    Đây là một dự án nhỏ của các thành viên trong nhóm chúng mình đến từ Trường Đại học Thương Mại và Học viện
                    Công nghệ Bưu chính Viễn thông lập nên để phục vụ bài tập lợn của chúng mình trên trường.
                </small>
            </div>
        </div>
    </div>
