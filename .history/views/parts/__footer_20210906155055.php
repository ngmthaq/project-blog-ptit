...
<footer class="text-center text-lg-start bg-light text-muted">
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
        ...
        <!-- Right -->
        <div>
            <a href="javascript:void(0)" class="me-4 text-reset d-inline-block mx-2">
        ...
        <div class="container text-center text-md-start mt-5">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-12 col-lg-3 col-xl-3 mx-auto mb-lg-0 mb-4">
                    ...
                    <p><i class="fas fa-phone me-3"></i> + 84 522 676 941</p>
                    <p><i class="fas fa-print me-3"></i> + 84 522 676 941</p>
                </div>
                <!-- Grid column -->
            </div>
            <!-- Grid row -->
