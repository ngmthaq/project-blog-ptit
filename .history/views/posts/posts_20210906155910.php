                ...
                <div class="col-lg-3 d-none d-lg-block">
                    ...
                    <div class="sidebar-header mt-5">
                        ...
                        <ul class="d-md-flex d-none social">
                            <li><a class="text-decoration-none text-dark" href="javascript:"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a class="text-decoration-none text-dark" href="javascript:"><i class="fab fa-instagram"></i></a></li>
                            <li><a class="text-decoration-none text-dark" href="javascript:"><i class="fab fa-tiktok"></i></a></li>
                            <li><a class="text-decoration-none text-dark" href="javascript:"><i class="far fa-envelope"></i></a></li>
                            <li><a class="text-decoration-none text-dark" href="javascript:"><i class="fas fa-phone"></i></a></li>
                        </ul>
