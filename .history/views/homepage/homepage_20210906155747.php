...
<body>
    <div class="main">
                ...
                <div class="row">
                    <?php if (count($posts) > 0) : ?>
                        ...
                        <div class="col-12 text-center">
                            <a href="index.php?action=posts" class="btn btn-dark my-2">XEM TẤT CẢ</a>
                        </div>
                    <?php else : ?>
        ...
        <section class="layout-pagination" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(./public/assets/img/paginate_1.jpg);">
            <h1>Danh mục</h1>
        </section>
